...
export default function ChatInterface({ isOpen, onClose, initialMessages = [] }: ChatInterfaceProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed top-16 left-0 right-0 bottom-0 bg-white dark:bg-gray-900 z-40 overflow-hidden px-0 w-screen"
    >
      <div className="h-full w-full relative overflow-x-hidden overflow-y-hidden">
        <div className="flex h-full w-full overflow-x-hidden overflow-y-hidden">
          ...
          {/* Messages Area */}
          <div ref={messagesContainerRef} className="flex-1 overflow-y-auto overflow-x-hidden px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 py-8 relative scrollbar-hide w-full max-w-full">
                    ...
                    <div className="flex gap-6 w-full max-w-full overflow-hidden">
                      <div className="flex-1 min-w-0">
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                          <p className="text-base text-gray-900 dark:text-white">{msg.text}</p>
                        </div>
                      </div>
                    ...
                    <div className="relative p-4 rounded-lg overflow-hidden min-w-0 max-w-full" id={`ai-message-${idx}`}>
                      ...
                      <div className="flex-1 min-w-0 overflow-hidden xl:overflow-visible">
                        ...
                        {idx === 1 && (
                          <div className="group inline-block absolute -left-8 top-1">
                            <Info className="w-5 h-5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 cursor-help" />
                            <div className="invisible group-hover:visible absolute left-0 top-6 w-80 bg-gray-900 dark:bg-gray-800 text-white text-xs rounded-lg p-3 shadow-lg z-50">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-p:text-gray-900 dark:prose-p:text-gray-100 prose-strong:font-bold prose-strong:text-gray-900 dark:prose-strong:text-white">
                          <ReactMarkdown
                            components={{
                              p: ({children}) => <p className="mb-4 leading-relaxed text-gray-900 dark:text-gray-100">{children}</p>,
                              h1: ({children}) => <h1 className="text-2xl font-bold mt-6 mb-3 text-gray-900 dark:text-white">{children}</h1>,
                              ...
                              li: ({children}) => <li className="text-gray-900 dark:text-gray-100 leading-relaxed">{children}</li>,
                              ...
                              a: ({href}) => (
                                <a
                                  ...
                                  className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 inline-flex items-center ml-1"
                                  title={href}
                                >
                          ...
                          <div className="mt-6 flex flex-wrap gap-3">
                            {messageQuestions[idx].map((question, qIdx) => (
                              <button
                                ...
                                className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left"
                              >
                      ...
                      <div className="w-full xl:w-80 2xl:w-96 xl:flex-shrink-0 overflow-hidden">
                        ...
                        {messageResources[idx] && messageResources[idx].length > 0 && (
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 md:flex-1">
                            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Related resources</h3>
                              ...
                              {messageResources[idx].slice(0, 3).map((resource, ridx) => {
                                ...
                                return (
                                  <a key={ridx} href={resource.url} target="_blank" rel="noopener noreferrer" className="block group py-2">
                                    <h4 className="text-sm font-normal text-gray-900 dark:text-white mb-1 group-hover:underline">
                                      {resource.title}
                                    </h4>
                                    ...
                                    <div className="flex items-center gap-1 mt-2">
                                      ...
                                      <span className="text-xs text-gray-500 dark:text-gray-400">{resourceType}</span>
                                    </div>
                                  </a>
                                );
                              })}
                        ...
                        {/* Related Products */}
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 md:flex-1">
                          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Related products</h3>
                          <div className="space-y-3">
                            <a href="/docs?section=compute&doc=compute-overview" className="block group">
                              <h4 className="text-sm font-normal text-gray-900 dark:text-white mb-1 group-hover:underline">
                            ...
                            <a href="/docs?section=storage&doc=fortress-object-storage" className="block group">
                              <h4 className="text-sm font-normal text-gray-900 dark:text-white mb-1 group-hover:underline">
                            ...
                            <a href="/docs?section=networking&doc=networking-overview" className="block group">
                              <h4 className="text-sm font-normal text-gray-900 dark:text-white mb-1 group-hover:underline">
          ...
          <div className="px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 py-3 bg-white dark:bg-gray-900 relative z-20">
            {/* Gradient overlay for shadow effect */}
            <div className="absolute -top-12 left-0 right-0 h-12 pointer-events-none dark:hidden" style={{background: 'linear-gradient(to bottom, rgba(255,255,255,0) 0%, rgba(255,255,255,0.7) 90%, rgba(255,255,255,1) 100%)'}}></div>
            <div className="absolute -top-12 left-0 right-0 h-12 pointer-events-none hidden dark:block" style={{background: 'linear-gradient(to bottom, rgba(17,24,39,0) 0%, rgba(17,24,39,0.7) 90%, rgba(17,24,39,1) 100%)'}}></div>
            <div className="w-full mx-auto">
              <div className="flex gap-6">
                <div className="flex-1">
                  <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 pb-3 pt-2 pl-2 pr-2 relative min-h-[120px]">
                    {/* Input field */}
                    <div className="mb-3">
                      <textarea
                        value={message}
                        ...
                        rows={2}
                        disabled={isLoading}
                        className="w-full px-4 py-3 rounded-lg border-0 focus:outline-none focus:ring-0 text-gray-900 dark:text-white bg-transparent placeholder-gray-400 dark:placeholder-gray-500 resize-none text-sm overflow-hidden disabled:opacity-50"
                      />
                    </div>

                    {/* Disclaimer - bottom left */}
                    <p className="absolute bottom-3 left-3 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <button
                      ...
                      className="absolute bottom-3 right-3 p-2 rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isLoading ? (
                        <div className="animate-spin h-[18px] w-[18px] border-2 border-white dark:border-gray-900 border-t-transparent rounded-full" />
                      ) : (
                        <Send size={18} />
                      )}
                    </button>
