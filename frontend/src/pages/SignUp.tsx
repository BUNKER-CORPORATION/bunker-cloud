      ...
      >
        ...
        <div className="bg-gradient-to-b from-neutral-900 to-black border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          <div className="mb-8">
            ...
            <p className="text-neutral-400">Get started with BUNKER CLOUD</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              {errors.name && (
                <p className="text-neutral-400 text-sm mt-1">{errors.name.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="text-neutral-400 text-sm mt-1">{errors.confirmPassword.message}</p>
              )}
            </div>
        ...
        <p className="text-center text-xs text-neutral-500 mt-6">
          ...
          <a href="#" className="hover:text-white transition-colors">Terms of Service</a> and{' '}
